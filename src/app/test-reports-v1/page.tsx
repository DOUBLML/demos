...
// -----------------------------------------------------------------------------
const orders = [
  { date: "2025-06-01", orders: 42, returns: 0 },
  { date: "2025-06-08", orders: 65, returns: 0 },
  { date: "2025-06-15", orders: 57, returns: 1 },
  { date: "2025-06-22", orders: 71, returns: 0 },
  { date: "2025-06-29", orders: 88, returns: 0 },
  { date: "2025-07-06", orders: 93, returns: 0 },
  { date: "2025-07-13", orders: 104, returns: 0 },
];
...
// Body measurements (example: underbust vs bust)
const bodyMeasurements = Array.from({ length: 120 }).map((_, i) => {
  const under = 68 + Math.random() * 22; // cm
  const bust = under + 6 + Math.random() * 18; // cm
  return {
    id: i + 1,
...
// Baseline return rate assumption for partner brand (what they'd expect without DOUBL)
...
// Color palette (let Tailwind/theme handle actual colors; recharts cells use defaults)
const COLORS = ["#0f766e", "#334155", "#7c3aed", "#f59e0b"]; // optional accents
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-6 space-y-6">
        ...
        <Tabs value={tab} onValueChange={setTab} className="w-full">
          ...
          {/* Placeholder content for existing tabs (replace with your actual components) */}
          ...
          {/* NEW: Reports tab tailored for Made-to-Measure */}
          <TabsContent value="reports" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">Orders (Weekly)</CardTitle>
                </CardHeader>
                <CardContent className="h-48">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              ...
              <CardContent className="h-80">
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  Use this distribution to guide pattern clusters, production
                  tolerances, and category expansion. Export to share with
                  factories and QA.
                </p>
                <div className="mt-2">
                  <Button
