        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-center space-x-8">
            {/* <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-600">Replace size selection</span>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="relative bg-black rounded-lg overflow-hidden aspect-[9/16] max-w-sm mx-auto">
                      ...
                      >
                        ...
                        <source
                          src="/videos/DOUBL-scan-demo.mp4"
                          type="video/mp4"
                        />
                      ...
                      <div className="absolute inset-0 bg-black/20">
                        ...
                        {/* <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                          <div className="text-4xl font-bold mb-2" style={{ color: '#800020' }}>
                            DOUBL
                          </div>
                          <p className="text-white text-sm">Your Fit ID</p>
                        </div> */}
